  ...
  return (
    <main className="relative flex min-h-screen items-center justify-center overflow-hidden bg-[#0a0a0f] px-4 grid-bg">
      <div className="pointer-events-none absolute inset-0">
        <div className="absolute left-1/2 top-1/2 h-[400px] w-[600px] -translate-x-1/2 -translate-y-1/2 rounded-full bg-purple-600/10 blur-[120px]" />
      </div>
      ...
      <div className="relative z-10 w-full max-w-md">
        ...
        <div className="gradient-border p-8">
          <h1 className="mb-1.5 text-2xl font-bold">Create account</h1>
          <p className="mb-6 text-sm text-gray-400">
            Start building apps with AI — free
          </p>
